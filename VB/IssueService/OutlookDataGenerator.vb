...
Namespace InfiniteAsyncSourceAdvancedSample
    Public NotInheritable Class OutlookDataGenerator
        ...
        Public Shared ReadOnly Tags() As String = { "wpf", "c#", ".net", "java", "php", "android", "python", "jquery", "html", "c++", "ios", "css", "mysql", "sql", "asp.net", "ruby-on-rails", "objective-c", "c", "arrays", "angularjs", "r", "json", "sql-server", "node.js", "iphone", "ruby", "swift", "regex", "ajax", "xml", "javascript", "winforms" }
